...
form_template.form_template_fields.create(:label => "Email", :sequence => 2, :type => "email_field")
form_template.form_template_fields.create(:label => "Phone", :sequence => 3, :type => "telephone_field")
form_template.form_template_fields.create(:label => "Preferred contact", :sequence => 4, :type => "select", :json => {:_ext => {:choices => "Home, Business, Mobile"}})
form_template.form_template_fields.create(:label => "Department", :sequence => 5, :type => "property_select", :json => {:_ext => {:property_name => "dept"}})
