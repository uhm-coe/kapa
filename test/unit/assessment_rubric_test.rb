...
class AssessmentRubricTest < ActiveSupport::TestCase
  test "is invalid without a title" do
    assessment_rubric = FormTemplate.new
  ...
  test "returns effective term if start_term_id and end_term_id are present" do
    assessment_rubric = FormTemplate.new(:title => "Music Education Fundamentals", :start_term_id => Term.current_term.id, :end_term_id => Term.next_term.id)
