class CreateInitialTables < ActiveRecord::Migration
  def change
    ...
    create_table "scholarship_applications", :force => true do |t|
      ...
      t.string  "major_primary"
      t.string  "major_secondary"
      t.string  "previous_major"
      t.string  "cohort"
      t.string  "expected_graduation"
      t.string  "expected_graduation_other"
      t.string  "subject_area"
      t.string  "scholarship_agreeement"
      t.string  "review_agreeement"
      t.string  "final_aggreement"
      t.date    "submit_date"
    ...
    create_table "scholarship_offers", :force => true do |t|
      t.integer "scholarship_id",       :null => false
      t.string  "academic_period"
      t.integer "amount"
      t.integer "default_award_amount"
    end

    create_table "scholarship_qualifications", :force => true do |t|
      t.integer "scholarship_offer_id",       :null => false
      t.integer "scholarship_application_id", :null => false
      t.string  "verified"
      t.date    "award_date"
    ...
    create_table "scholarships", :force => true do |t|
      ...
      t.text    "purpose"
      t.text    "eligibility"
      t.text    "eligibility_short"
      t.text    "criteria"
      t.decimal "cum_gpa",              :precision => 6, :scale => 3,                   :null => false
      t.string  "attending_status",                                                     :null => false
      t.string  "level",                                                                :null => false
      t.string  "highschool_graduated",                                                 :null => false
