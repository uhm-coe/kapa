module Kapa::MessageBase
  ...
  included do
    ...
    serialize :to, Kapa::CsvSerializer
    serialize :from, Kapa::CsvSerializer
    serialize :cc, Kapa::CsvSerializer
    serialize :bcc, Kapa::CsvSerializer
    serialize :reply_to, Kapa::CsvSerializer
  end
