class Admin::CriterionsController < Admin::BaseController
  ...
  def update
    ...
    redirect_to admin_rubric_path(:id => @assessment_criterion.assessment_rubric_id, :focus => :criterions, :criterion => @assessment_criterion.criterion)
  end
  ...
  def destroy
    ...
    unless @assessment_criterion.assessment_scores.blank?
      ...
      redirect_to admin_rubric_path(:id => @assessment_criterion.assessment_rubric_id, :focus => :criterions) and return false
    end
    ...
    redirect_to admin_rubric_path(:id => @assessment_criterion.assessment_rubric_id, :focus => :criterions)
  end
