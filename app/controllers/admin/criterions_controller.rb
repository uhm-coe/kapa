class Admin::CriterionsController < Admin::BaseController
  ...
  def update
    ...
    redirect_to admin_rubric_path(:id => @assessment_criterion.assessment_rubric_id)
  end
  ...
  def destroy
    ...
    unless @assessment_criterion.assessment_scores.blank?
      ...
      redirect_to admin_rubric_path(:id => @assessment_criterion.assessment_rubric_id) and return false
    end
