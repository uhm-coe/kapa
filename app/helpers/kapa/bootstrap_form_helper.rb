module Kapa::BootstrapFormHelper
  ...
  class BootstrapFormBuilder < ActionView::Helpers::FormBuilder
    ...
    def self.build_label_field(name)
      define_method(name) do |method, *args|
        case name.to_s
          ...
          when "model_select", "person_select", "user_select", "property_select", "program_select", "term_select", "history_select", "date_select"
            options = args.first.is_a?(Hash) ? args.first : {}
    ...
    helpers = %w{text_field password_field text_area file_field check_box radio_button select static property_select term_select program_select history_select person_select user_select date_select}
