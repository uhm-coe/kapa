module Kapa::BootstrapFormHelper
  ...
  class BootstrapFormBuilder < ActionView::Helpers::FormBuilder
    ...
    helpers = %w{text_field password_field text_area file_field check_box radio_button select static property_select term_select program_select history_select user_select date_picker person_select date_select}
